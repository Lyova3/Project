The goal of this project is to design and implement a lightweight, scalable, in-memory database capable of handling large datasets efficiently. Our MiniDB supports:
...
Use a custom graph implementation (no external libraries): Nodes: Developers and Publishers Edges: Collaboration between a developer and publisher if they worked on the same game Edge weight: Number of shared games
